...
public interface ExpenseService 
{
    ...
    ApiSuccessResult<UpdateExpenseResult> update(UpdateExpenseRequest request, String token) throws Exception;
    ApiSuccessResult<DeleteExpenseResult> delete(DeleteExpenseRequest request, String token) throws Exception;
}
